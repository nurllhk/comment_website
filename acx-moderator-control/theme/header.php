			...
			<ul class="navbar-nav">
				<li class="nav-item dropdown dropdown-user">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="<?php echo MADMIN_URL; ?>/index.php?page=account" class="dropdown-item"><i class="icon-cog3"></i> Hesap Bilgilerim</a>
						<a href="<?php echo MADMIN_URL;?>/logout.php" class="dropdown-item"><i class="icon-switch2"></i> Çıkış</a>
					</div>
				</li>
			</ul>
		</div>
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="ml-3 align-self-center">
								<a href="<?php echo MADMIN_URL; ?>/index.php?page=account" class="text-white"><i class="icon-cog3"></i></a>
							</div>
						</div>
					</div>
				</div>
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar sidebar_informations" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu <?php if(m_a_g('page')=='') { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>" class="nav-link"><i class="icon-home4"></i> <span>Anasayfa</span></a>
						</li>
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'review') and !strstr(m_a_g('page'),'review_statistics') and m_a_g('problem')!='true') { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=reviews" class="nav-link"><i class="icon-pencil7"></i> <span>İncelemeler</span> <span class="badge badge-warning align-self-center ml-auto"><?php echo $waiting_reviews_count; ?></span></a>
						</li>
						<li class="nav-item nav-item-submenu <?php if(m_a_g('problem')=='true') { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=reviews&problem=true" class="nav-link"><i class="icon-alert"></i> <span>Sorunlu İncelemeler</span> <span class="badge badge-danger align-self-center ml-auto"><?php echo $problem_reviews_count; ?></span></a>
						</li>
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'comments')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=comments" class="nav-link"><i class="icon-comment-discussion"></i> <span>Yorumlar</span> <span class="badge badge-warning align-self-center ml-auto"><?php echo $waiting_comments_count; ?></span></a>
						</li>
						...
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'notification')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=notification" class="nav-link"><i class="icon-bell-plus"></i> <span>Bildirim Gönder</span></a>
						</li>
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'add_comment')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=add_comment" class="nav-link"><i class="icon-comment"></i> <span>Yorumla</span></a>
						</li>
				
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'support_template')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=support_templates" class="nav-link"><i class="icon-insert-template"></i> <span>Destek Şablonları</span></a>
						</li>
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'contact')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=contact" class="nav-link"><i class="icon-envelope"></i> <span>Mesajlar</span> <span class="badge badge-warning align-self-center ml-auto"><?php echo $waiting_contact_count; ?></span></a>
						</li>
					
					
						<li class="nav-item nav-item-submenu <?php if(strstr(m_a_g('page'),'moderators')) { echo 'nav-item-expanded nav-item-open'; } ?>">
							<a href="<?php echo MADMIN_URL; ?>/index.php?page=moderators" class="nav-link"><i class="icon-user-tie"></i> <span>Moderatörler</span></a>
						</li>
