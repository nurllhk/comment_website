...
<div class="card">
		<div class="card-header header-elements-sm-inline">
			...
			<a href="<?php echo MADMIN_URL; ?>/index.php?page=brand_add"><span class="btn bg-success-400 btn-labeled btn-labeled-left"><b><i class="icon-add"></i></b> Marka Ekle</span></a>
			</div>
		</div>
		<div class="card-body">
