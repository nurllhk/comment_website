...
<div class="card">
		<div class="card-header header-elements-sm-inline">
			<h6 class="card-title">Resimsiz Ürünler</h6>
			<div class="text-right" style="margin-right:10px;">
			<a href="<?php echo MADMIN_URL; ?>/index.php?page=product_add"><span class="btn bg-success-400 btn-labeled btn-labeled-left"><b><i class="icon-add"></i></b> Ürün Ekle</span></a>
			</div>
		</div>
		<div class="card-body">
		...
		<div class="ajax_table" rel="no_image_products">
