...
<div class="collapse navbar-collapse" id="navbar-component">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a href="<?php echo MADMIN_URL;?>/index.php?page=withdrawals&status=0" class="navbar-nav-link">Para Çekimleri</a>
		</li>
		<li class="nav-item">
	...
	if($user_withdrawals['total_count']>0)
	{
		foreach($user_withdrawals['data'] as $withdraw)
		{
			...
			<tr>
				...
				<a href="'.MADMIN_URL.'/index.php?page=withdraw_detail&id='.$withdraw['id'].'" target="_blank"><span class="btn bg-info-400"><b><i class="icon-eye"></i></b></span></a>
				</td>
			</tr>';
		}
	}
