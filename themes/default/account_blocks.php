...
<div class="main">
	<div class="container">
		...
		<div class="page_head">
		<div class="page_icon"><i class="fa fa-user-slash"></i></div>
		...
		<div class="col-xl-8 col-lg-8 col-sm-8 col-12">
			...
			<div class="page_title"><h2>Engellediğiniz Kullanıcılar</h2></div>
			</div>
			...
			<div class="friendship_list">
				...
				u.sef as u_sef
				from user_blocks ub
				inner join users u on ub.blocked_user=u.id
				where ub.u_id='".USER['id']."' order by ub.id desc")->fetchAll(PDO::FETCH_ASSOC);
						...
						<div class="friendship_user">
								...
								<div class="friendship_user_detail">
									...
									<div class="user_actions">
										<div class="user_block_delete" data-user-id="'.$user.'">
											<div class="user_block_delete_icon"><i class="fa fa-ban"></i></div>
											<div class="user_block_delete_text">Engeli Kaldır</div>
										</div>
				...
				{
					echo m_alert('Bilgi','Henüz engellediğiniz bir kişi bulunmuyor.');
				}
				?>
			</div>
