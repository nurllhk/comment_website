...
<div class="main">
	<div class="container">
		...
		<div class="page_title"><h1>Takipçilerim</h1></div>
		</div>
		<div class="row">
		...
		<div class="col-xl-8 col-lg-8 col-sm-8 col-12">
			...
			<div class="page_title"><h2>Sizi Takip Eden Kullanıcılar</h2></div>
			</div>
			...
			<div class="friendship_list">
				...
				u.sef as u_sef,
				(select count(*) from user_followers where u_id='".USER['id']."' and follow_user=uf.u_id) as followed
				from user_followers uf
				inner join users u on uf.u_id=u.id
				where uf.follow_user='".USER['id']."' order by uf.id desc")->fetchAll(PDO::FETCH_ASSOC);
					...
					foreach($informations as $info)
					{
						...
						<div class="friendship_user">
								...
								<div class="friendship_user_detail">
									...
									{
										echo '
										<div class="user_follow" data-user-id="'.$user.'" data-remove="false">
											<div class="user_follow_icon"><i class="fa fa-plus-circle"></i></div>
											<div class="user_follow_text">Takip Et</div>
										</div>';
									}
									else
									{
				...
				{
					echo m_alert('Bilgi','Henüz bir takipçiniz bulunmuyor.');
				}
				?>
			</div>
