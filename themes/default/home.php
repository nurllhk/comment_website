...
<div class="main">
		<div class="container">
			...
			<div class="page_title"><h2>Bu Hafta En Çok Tartışılan Ürün Yorumları</h2></div>
			</div>
			...
			$review_list->include_product 			= true;
			$review_list->query_options 			= "where r.status='1'";
			$review_list->order 					= "order by r_week_comment_count desc, r_liked desc";
			$review_list->limit 					= 1; //2
			$result = $review_list->list_reviews();
			echo $result['html'];
			?>
			...
			<a href="javascript:void(0);"><span class="btn btn-default btn-sm w-100 mb-3 other_reviews_btn" data-page="2"><span class="spinner-border spinner-border-sm"></span> Daha fazla göster</span></a>
			</div>
			<?php
