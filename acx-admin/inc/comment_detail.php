...
<div class="collapse navbar-collapse" id="navbar-component">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a href="<?php echo ADMIN_URL;?>/index.php?page=comments&status=0" class="navbar-nav-link">Yorumlar</a>
		</li>
		<li class="nav-item">
...
<form action="" method="post" enctype="multipart/form-data">
	<div class="form-group row">
		...
		<div class="col-lg-9">
			<a href="<?php echo ADMIN_URL; ?>/index.php?page=review_detail&id=<?php echo $info['r_id']; ?>" target="_blank"><?php echo $db->table('reviews')->where('id','=',$info['r_id'])->get_var('title'); ?></a>
		</div>
	</div>
	<div class="form-group row">
