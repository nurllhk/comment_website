	...
	if($informations['total_count']>0)
	{
		foreach($informations['data'] as $info)
		{
			...
			<tr>
				...
				<a href="'.ADMIN_URL.'/index.php?page=withdraw_detail&id='.$info['id'].'"><span class="btn bg-info-400"><b><i class="icon-eye"></i></b></span></a>
				<a class="delete" href="'.ADMIN_URL.'/index.php?page=delete&table=withdrawals&id='.$info['id'].'"><span class="btn bg-danger-400"><b><i class="icon-trash"></i></b> </span></a>
				</td>
			</tr>';
		}
	}
