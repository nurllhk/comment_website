...
<div class="collapse navbar-collapse" id="navbar-component">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a href="<?php echo ADMIN_URL;?>/index.php?page=rejected_types" class="navbar-nav-link">Red Nedenleri</a>
		</li>
		<li class="nav-item">
...
<h5 class="card-title">Red Nedeni Ekle</h5>
</div>
...
if($_POST)
{
	...
	$query = $db->table('rejected_types')->insert($data);
...
<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="col-lg-9">
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="copy" data-fouc>
					Aktif
				</label>
			</div>
			...
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="copy" value="0" checked data-fouc>
					Pasif
				</label>
			</div>
		</div>
	...
	<div class="form-group row">
		...
		<div class="col-lg-9">
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-clone" checked data-fouc>
					<i class="fa fa-clone"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-images" data-fouc>
					<i class="fa fa-images"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-photo-video" data-fouc>
					<i class="fa fa-photo-video"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-image" data-fouc>
					<i class="fa fa-image"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-keyboard" data-fouc>
					<i class="fa fa-keyboard"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-text-width" data-fouc>
					<i class="fa fa-text-width"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-remove-format" data-fouc>
					<i class="fa fa-remove-format"></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-exclamation-circle" data-fouc>
					<i class="fa fa-exclamation-circle"></i></i>
				</label>
			</div>
			<div class="form-check form-check-inline">
				<label class="form-check-label">
					<input type="radio" class="form-input-styled" name="icon" value="fa fa-window-maximize" data-fouc>
