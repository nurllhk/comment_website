...
<div class="card">
		<div class="card-header header-elements-sm-inline">
			...
			<a href="<?php echo ADMIN_URL; ?>/index.php?page=category_add"><span class="btn bg-success-400 btn-labeled btn-labeled-left"><b><i class="icon-add"></i></b> Kategori Ekle</span></a>
			</div>
		</div>
