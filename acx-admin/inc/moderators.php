...
<div class="card">
	<div class="card-header header-elements-sm-inline">
		...
		<a href="<?php echo ADMIN_URL; ?>/index.php?page=moderator_add"><span class="btn bg-success-400 btn-labeled btn-labeled-left"><b><i class="icon-add"></i></b> Moderatör Ekle</span></a>
		</div>
	</div>
	...
	if($informations['total_count']>0)
	{
		foreach($informations['data'] as $info)
		{
			...
			<tr>
				...
				<a href="'.ADMIN_URL.'/index.php?page=moderator&id='.$info['id'].'"><span class="btn bg-info-400 btn-block mb-2"><b><i class="icon-pencil"></i></b></span></a>
				<a class="delete" href="'.ADMIN_URL.'/index.php?page=delete&table=moderators&id='.$info['id'].'"><span class="btn bg-danger-400 btn-block mb-2"><b><i class="icon-trash"></i></b> </span></a>
				</td>
			</tr>';
		}
	}
