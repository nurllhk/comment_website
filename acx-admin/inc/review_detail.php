...
<div class="collapse navbar-collapse" id="navbar-component">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a href="<?php echo ADMIN_URL;?>/index.php?page=reviews&status=0" class="navbar-nav-link">İncelemeler</a>
		</li>
		<li class="nav-item">
...
<div class="card-body">
	...
	<div class="form-group row">
		...
		<div class="col-lg-6">
			<a href="<?php echo ''.ADMIN_URL.'/index.php?page=product&id='.$info['p_id'].''; ?>" target="_blank">Ürünü Düzenle</a>
		</div>
	</div>
	<div class="form-group row">
