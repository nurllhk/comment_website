...
<div class="collapse navbar-collapse" id="navbar-component">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a href="<?php echo ADMIN_URL;?>/index.php?page=support&status=0" class="navbar-nav-link">Destek Talepleri</a>
		</li>
		<li class="nav-item">
	  ...
	  <?php
		  ...
		  <li class="list-group-item d-flex justify-content-between align-items-start">
			<div class="ms-2 me-auto">
			  ...
			  <a href="<?php echo ADMIN_URL; ?>/index.php?page=review_detail&id=<?php echo $review_info['id']; ?>" target="_blank"><?php echo $review_info['title']; ?></a>
			</div>
		  </li>
	  <?php
			}
